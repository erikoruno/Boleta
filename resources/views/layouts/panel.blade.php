        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index.html">
                            {{-- <img class="img-fluid" src="{{ asset('images/utea1.png')}}" alt="Theme-Logo" /> --}}
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                ...
                                {{-- <a href="#!">
                                 ...
                                 {{-- <ul class="show-notification">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="as{{ asset('images/avatar-3.jpg')}}" alt="Generic placeholder image">
                                            <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="{{ asset('images/usuario.png')}}" class="img-radius" alt="User-Profile-Image">
                                    @auth
                                    
                                    <span>{{ auth()->user()->name}} {{ auth()->user()->apellidopaterno }} {{ auth()->user()->apellidomaterno }}
                                        </span>
            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <img class="img-40 img-radius" src="{{ asset('images/usuario.png')}}" alt="User-Profile-Image">
                                    
                                    <div class="user-details">
                                        {{-- <span>John Doe</span> --}}
                                        <span id="more-details">{{ auth()->user()->name}} {{ auth()->user()->apellidopaterno }} {{ auth()->user()->apellidomaterno }}<i class="ti-angle-down"></i></span>
                                    </div>
                                    <div>
                                       DNI: {{ auth()->user()->dni}}
                                    </div>
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            ...
                                            <a href="{{ route('logout') }}"
                                            onclick="event.preventDefault(); document.getElementById('formLogout').submit();">
                                            <i class="ti-layout-sidebar-left"></i>Cerrar sesiòn</a>
                                            <form action="{{ route('logout')}}" method="POST" style="display: none;" id="formLogout">
                                                @csrf
                                            </form>
                                        </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                @if($user->isAdmin())
                                <li>
                                    <a href="{{ url('/boletas/create')}}">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Ingresar datos a boleta</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                @endif
                                {{-- <li>                                  
                                    <a href="{{ route ('register')}}">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Registrar nuevo usuario</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>                                  
                                </li> --}}
                    ...
                    <style>
                        .bordered-table {
                            border: 2px solid #333; /* Borde más grueso y color gris oscuro */
                            border-collapse: collapse;
                        }

                        .bordered-table th, 
                        .bordered-table td {
                            border: 1px dashed #333; /* Bordes internos con línea discontinua */
                            padding: 10px; /* Mayor espacio interno */
                        }
                      </style>
                     
                    <form action="{{ route('boletas.pdf')}}" method="GET" target= "_blank">
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <h3>Ingrese los datos requeridos </h3>
                                <div style="display: inline-block; margin-rigth: 10px;">
                                            ...
                                            <thead> 
                                                ...
                                                <tbody>
                                                    ...
                                                    <button type= "submit" >Generar Boleta</button>
                                                      {{-- <a href="{{ url('/boletas')}}" target="_blank" >
                                                        <br>
                                                            Generar boleta
                                                      </a> --}}
                                                        </td>
                                ...
                                {{-- <div class="page-wrapper"> --}}
                                    {{-- Toda la parte del dahsboard Inicio--}}
                                    {{-- <div class="page-body">
                                        <div class="row">
                                            <!-- card1 start -->
                                                        ...
                                                        <div class="to-do-list">
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="#!"><img src="{{ asset('images/avatar-2.jpg')}}" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                                                        <a href="#!"><img src="{{ asset('images/avatar-3.jpg')}}" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                                                        <a href="#!"><img src="{{ asset('images/avatar-4.jpg')}}" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
